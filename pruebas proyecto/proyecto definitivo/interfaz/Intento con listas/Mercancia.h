...
private:
    ...
    int capacidad_buque;
    ListaDatos *merca;
    void escribirRES(vector<ListaDatos> &seleccionados);
...
public:
    ...
    Mercancia(int tipos, int capacidad, ListaDatos *merca) : tipos_mercancias(tipos), capacidad_buque(capacidad), merca(merca) {}
    ...
    int getCapacidad();
    void setMerca(ListaDatos *);
    ListaDatos getMerca(int);
